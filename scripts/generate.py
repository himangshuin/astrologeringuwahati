...
BLOG_POSTS = [
    dict(icon="icon-tarot", svg=SERVICE_CARDS[0][1], title="5 Signs You Need a Tarot Reading Immediately",
         href=U_POST1, meta="5 min read", desc="Discover the unmistakable signs that the universe is calling you for guidance through tarot...",
...
def build_post1():
    ...
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="{U_POST1}">
